    ...
    return (
        <section className="py-24 bg-aeris-black border-t border-white/5">
            <div className="max-w-7xl mx-auto px-6">
                <h2 className="text-3xl md:text-4xl font-bold text-white mb-16 text-center">MISSION PROTOCOL</h2>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 relative">
                    ...
                    {steps.map((step, i) => (
                        <div key={i} className="relative z-10 flex flex-col items-center text-center">
                            <div className="w-24 h-24 bg-aeris-black border border-radar-green/30 text-radar-green flex items-center justify-center font-mono text-3xl font-bold mb-6 rounded-full shadow-[0_0_20px_rgba(81,138,22,0.2)]">
                                {step.num}
                            </div>
